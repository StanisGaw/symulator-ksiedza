...
- Odpoczynek w ciągu dnia: ławka przed kościołem pozwala usiąść z brewiarzem, na plebanii można się zdrzemnąć dwie godziny albo zjeść obiad. Każdy kolejny odpoczynek tego dnia daje mniej energii (100, 60, 40 i 20 procent wartości), więc dzień da się uratować, ale nie da się w kółko resetować zmęczenia.
...
- Krótkie sceny czynności: zamiatanie placu, sprzątanie kościoła, spowiedź, brewiarz i sen mają własne scenki. Ksiądz chodzi z miotłą, siada w konfesjonale, do którego podchodzą kolejni penitenci, czyta na ławce, kładzie się na łóżku, a ekran ciemnieje. Każdą scenę można pominąć przyciskiem, a zegar biegnie razem z nią.
