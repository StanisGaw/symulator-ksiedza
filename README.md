...
- Msze o stałych porach: w dzień powszedni o 7:00 i 19:00, a w niedziele i święta nakazane dochodzi suma o 12:00. Żeby zacząć, trzeba być przy ołtarzu najwyżej kwadrans przed i najwyżej dziesięć minut po. Każda odprawiona msza to +2 punkty szacunku (w niedzielę i święta +4), każda opuszczona to -3 szacunku, -2 tradycjonalistów i -1 reputacji, rozliczane w chwili, gdy mija jej pora. Frekwencja zależy od godziny: poranna ma trzy czwarte, wieczorna pięć szóstych, a msza o godzinie ustalonej z parafianami dostaje dodatkowe dziesięć procent. Szacunek jest widoczny w pasku i będzie walutą drzewek rozwoju.
- Odpoczynek w ciągu dnia: na ławce przed kościołem wybiera się suwakiem, ile czasu tam spędzić, od kwadransa do czterech godzin. Godzina daje +10 energii, czyli mniej niż godzina snu, więc siedzenie nigdy nie bije nocy. Jest też gotowy przycisk „Poczekaj do mszy”, który odlicza czas dokładnie do otwarcia okna najbliższej mszy. Na plebanii można zjeść obiad, najwyżej dwa razy dziennie.
...
- Krótkie sceny czynności: zamiatanie placu, sprzątanie kościoła, spowiedź, brewiarz i sen mają własne scenki. Zamiatanie to krótkie wymachy miotłą w lewo i w prawo, w miejscu i tak samo na placu jak w kościele. Ksiądz siada w konfesjonale, do którego podchodzą kolejni penitenci, czyta na ławce, kładzie się na łóżku, a ekran ciemnieje. Każdą scenę można pominąć przyciskiem, a zegar biegnie razem z nią.
